...
# add V0 and N0 to the REZs list
REZs = np.append(REZs, ['V0', 'N0'])
#%% 
...
for year in ref_years:
    ...
    wind_files_no_REZ = [file for file in wind_files if file.split('_')[0] not in REZs]    # get all the files that do not contain REZ in their name
